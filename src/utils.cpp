...
artec::yal::DateTime artec::yal::toDateTime(const std::chrono::system_clock::time_point& timePoint) noexcept
{
    const int32_t time = static_cast<int32_t>(std::chrono::system_clock::to_time_t(timePoint));
